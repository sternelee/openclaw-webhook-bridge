...
export function MobileHeader({
  ...
  return (
    <header className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b border-border/50 bg-card/50 backdrop-blur safe-area-top">
        ...
        <div className="md:hidden">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem
                onClick={onToggleThinking}
                className={cn("gap-2 cursor-pointer touch-target", showThinking && "bg-accent/10")}
              >
                <Icons.brain className="h-4 w-4" />
