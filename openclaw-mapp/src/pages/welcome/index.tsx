      ...
      <View className="welcome-page">
        <View className="welcome-container">
          ...
          <View className="setup-section">
            ...
            <Text className="section-desc">请输入 WebSocket 服务器地址以连接到 OpenClaw 服务</Text>
            ...
            <View className="button-group">
              <Button className="connect-btn primary" onClick={this.handleConnect}>
                连接服务器
              </Button>
          ...
          <View className="info-section">
            ...
            <View className="info-list">
              <View className="info-item">
                ...
                <Text className="info-text">首次使用需要配置 WebSocket 服务器地址</Text>
              </View>
              <View className="info-item">
                <Text className="info-dot">•</Text>
                <Text className="info-text">配置后可在"设置"页面修改服务器地址</Text>
              </View>
              <View className="info-item">
                <Text className="info-dot">•</Text>
